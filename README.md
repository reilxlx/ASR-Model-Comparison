...
| 百度ASR | 100% (171/171) | 7.70% | 1679.65 | 9.82 | N/A (CPU only) |

*注: 上述模型使用多种设备测试，测试结果仅供参考（阿里ASR、百度ASR使用同款CPU，Dolphin与前两者不同）
