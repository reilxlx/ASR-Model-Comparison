...
| ASR模型 | 文件处理成功率 | 总处理时间(秒) | 平均处理时间/文件(秒) | 显存占用 |
| --- | --- | --- | --- | --- |
| FunASR-GPU版本 | 100% (171/171) | 85.80 | 0.50 | ~3GB (RTX 3080) |
| SenseVoice | 100% (171/171) | 27.51 | 0.16 | ~1.5GB (RTX 4090) |
| FunASR-CPU版本 | 100% (171/171) | 115.11 | 0.67 | N/A (CPU only) |
| Kimi-Audio | 100% (171/171) | 203.12 | 1.19 | ~30GB (RTX 4090) |
| Dolphin | 100% (171/171) | 101/52* | 0.59/0.30* | ~2.3GB (RTX 4090/3080*) |
| FireRedASR | 100% (171/171) | - | - | - |
